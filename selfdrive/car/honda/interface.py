...
class CarInterface(CarInterfaceBase):
  ...
  @staticmethod
  def get_params(candidate, fingerprint=gen_empty_fingerprint(), car_fw=[], DisableRadar=True):  # pylint: disable=dangerous-default-value
    ...
    if candidate in HONDA_BOSCH:
      ...
      ret.openpilotLongitudinalControl = DisableRadar
