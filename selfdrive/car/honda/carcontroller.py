...
class CarController(object):
  ...
  def update(self, sendcan, enabled, CS, frame, actuators, \
    ...
    if (frame % 10) == 0:
      idx = (frame/10) % 4
      can_sends.extend(hondacan.create_ui_commands(self.packer, pcm_speed, hud, CS.CP.carFingerprint, CS.CP.openpilotLongitudinalControl and (not CS.useTeslaRadar), idx))
